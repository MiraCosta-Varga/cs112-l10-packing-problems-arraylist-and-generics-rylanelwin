  ...
  public void addItems(int listNumber) {
    ...
    */
    ...
    if(listNumber == 1) {// Add to Food list
      ...
      System.out.println(newFoodItem + " added to list");
      ...
      System.out.println(newPartsItem + " added to list");
      ...
      System.out.println(newSuppliesItem + " added to list");
    ...
    */
    ...
    if(listNumber == 1) { // Food
      ...
      */
      ...
      foodList.remove(foodInventory.searchByName(foodList, name));
      ...
      */
      ...
      System.out.println("Removing " + name);
      partsList.remove(partsInventory.searchByName(partsList, name));
      ...
      */
      ...
      System.out.println("Removing " + name);
      suppliesList.remove(suppliesInventory.searchByName(suppliesList, name));
